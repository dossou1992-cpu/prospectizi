...
export default function ProspectCard({ prospect, onReportFaulty }: ProspectCardProps) {
  const { updateProspectStatus, updateProspectNotes } = useStore();
  ...
  return (
    <div className="bg-dark-800 border border-cyan/20 hover:border-cyan/40 rounded-2xl p-6 transition-all duration-300 shadow-xl relative overflow-hidden group">
      {/* Top Ambient Glow */}
        ...
        <div className="lg:col-span-8 space-y-5">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="text-[10px] font-bold uppercase tracking-wider bg-dark-700 text-slate-300 px-2 py-0.5 rounded-md border border-dark-600">
                  Canal : {prospect.channel.replace('_', ' ')}
                </span>
                <span className="text-[10px] text-slate-400">Collecté le {prospect.collected_at}</span>
              </div>
          ...
          <div className="bg-gradient-to-r from-dark-900 via-dark-850 to-dark-900 border-l-4 border-cyan border-y border-r border-dark-700/60 rounded-xl p-3.5">
            <span className="text-[10px] font-extrabold text-cyan uppercase tracking-wider block mb-1">
              🌟 Solution sur-mesure à lui proposer (croisement Avatar × Faille) :
            </span>
          ...
          <div className="bg-dark-900 border border-dark-600 rounded-xl p-4 space-y-3">
            ...
            <div className="bg-dark-950/70 p-3.5 rounded-xl border border-dark-700 text-xs text-slate-200 font-normal leading-relaxed italic relative">
              &quot;{currentMsgText}&quot;
            </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-2 pt-1">
              ...
              <span className="text-[11px] text-slate-400">
                {currentMsgText.split(' ').length} mots • Ton respectueux
              </span>
            </div>
          </div>
          ...
          <div className="bg-dark-900/50 border border-dark-700 rounded-xl p-3 space-y-2">
            <div className="flex items-center justify-between text-xs">
              <span className="font-semibold text-slate-300 flex items-center gap-1.5">
                ...
                Notes Privées & Instructions de suivi
              </span>
              {isEditingNotes ? (
                <button
        ...
        <div className="lg:col-span-4 bg-dark-900/90 border border-dark-700/80 rounded-xl p-4 flex flex-col justify-between space-y-5">
          ...
          <div className="pt-3 border-t border-dark-700 flex items-center justify-between">
            <button
              ...
              title="Signaler un hard bounce email ou un faux numéro pour récupérer votre crédit"
            >
